 ...
 *
 * MIGRATION: F — replace with lightning-flow once Expense_Screen exists.
 */
export default class CgcExpenseWizard extends LightningElement {
    @api recordId;
    @track error;
    @track rows = [];
    columns = [
    ...
    handleApply() {
        this.error = 'Flow Expense_Screen is not deployed in this legacy pro-code org.';
    }

 ...
 *
 * MIGRATION: F — replace with lightning-flow once Field_Order_Screen exists.
 */
export default class CgcOrderBasket extends LightningElement {
    @api recordId;
    @track error;
    @track rows = [];
    columns = [
    ...
    handleApply() {
        this.error = 'Flow Field_Order_Screen is not deployed in this legacy pro-code org.';
    }
